...
describe('Hacker News fixtures', () => {
    ...
    const processingFixtures = [
        {
            ...
            sourceSelector: 'span.age',
            linkSelector: 'a[href="item?id=49476604"]',
            original: '1 hour ago',
            expected: '2026-08-28 10:09',
            eligible: true,
        },
        {
            name: 'discussion.html',
            url: 'https://news.ycombinator.com/item?id=49476604',
            sourceSelector: 'span.age',
            linkSelector: 'a[href="item?id=49476605"]',
            original: '52 minutes ago',
            expected: '2026-08-28 10:17',
            eligible: true,
        },
        {
            name: 'absolute.html',
            url: 'https://news.ycombinator.com/newest',
            sourceSelector: '#absolute',
            linkSelector: '#absolute-link',
            original: 'Aug 27, 2026',
            expected: 'Aug 27, 2026',
            eligible: false,
        },
    ] as const;
    ...
    it('keeps profile prose and eligibility boundaries unchanged', () => {
        ...
        const controller2 = new DocumentTransformationController({
            url: new URL('https://news.ycombinator.com/news'),
            root: document,
            locales: ['en-US'],
        ...
        async () => {
            ...
            try {
                controller = new DocumentTransformationController({
                    url: new URL('https://news.ycombinator.com/news?p=2#matrix'),
                    root: document,
                    locales: ['en-US'],
                    diagnosticSink: sink,
                    display: { formatMode: 'custom', pattern: 'yyyy', timeZone: { mode: 'utc' } },

...
| --- | --- | --- |
| `questions.html` | <https://stackoverflow.com/questions> and <https://superuser.com/questions> | Process `span.relativetime[title]` labels in place. |
...
| `eligibility-matrix.html` | Synthetic trust boundaries | Process only approved shapes with strict explicit-zone timestamps. |

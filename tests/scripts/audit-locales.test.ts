...
// Assembled from parts: a plain string holding `${...}` would trip no-template-curly-in-string.
const TEMPLATE_SOURCE = ['const label = `Fixed fixture · ', '$', '{instant}`;'].join('');

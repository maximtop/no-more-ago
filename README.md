...
K, TikTok, LinkedIn, and Bluesky have specialized sources for trusted or
best-effort
...
| Situation | Result |
| --- | --- |
| Eligible zoned standard, Facebook, GitHub, Hacker News, Stack Exchange, Telegram Web K, LinkedIn, or Bluesky timestamp | The trusted or best-effort instant is shown with the configured exact-date presentation. |
...
labels, nearby text, or elapsed time. Apart from the explicitly documented
Bluesky and TikTok identity inputs, link destinations are not timestamp inputs.
The Hacker News specialized source

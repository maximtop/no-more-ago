/**
 * @file Configuration for this repository's extension deployment flow.
 */
 ...
 */
export const AMO_APPROVAL_NOTES_SUMMARY = 'Replaces relative timestamps with exact dates on '
    + 'supported websites. No extension account, no remote code. The only network requests are '
    + 'credential-free lookups of public Bluesky posts at https://public.api.bsky.app, sent with '
    + 'public actor and post identifiers.';
